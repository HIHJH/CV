...
data_dir = "C:/Users/jhHwang/Desktop1/VOC/VOCdevkit/VOC2012"
resize_size = 256
...
#model.load_state_dict(torch.load('UNet_trained_model.pth', map_location=torch.device('cpu')))
model.load_state_dict(torch.load('resnet_encoder_unet.pth', map_location=torch.device('cpu')))
